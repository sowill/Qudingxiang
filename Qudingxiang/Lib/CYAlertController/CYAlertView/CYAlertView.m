...
/** 消息 */
@property (nonatomic, strong)UILabel *messageOffLineLabel;

/** 消息 */
@property (nonatomic, strong)UIWebView *messageLabel;
...
- (_Nonnull instancetype)initWithOffLineTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message
{
    ...
    _messageOffLineLabel = [[UILabel alloc] init];
    
    // 添加到父视图
    [self addSubview:_containerView];
    [_containerView addSubview:_scrollView];
    [_scrollView addSubview:_titleLabel];
    [_containerView addSubview:_messageOffLineLabel];
    ...
    // 设置 messageLabel
    _messageOffLineLabel.text = message;
    _messageOffLineLabel.textAlignment = NSTextAlignmentCenter;
    _messageOffLineLabel.numberOfLines = 0;
    _messageOffLineLabel.font = [UIFont systemFontOfSize:13.0];
    ...
    // 添加约束 messageLabel
    _messageOffLineLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [NSLayoutConstraint constraintWithItem:_messageOffLineLabel
                                 attribute:NSLayoutAttributeWidth
                                 relatedBy:NSLayoutRelationEqual
                                    toItem:nil
                                 attribute:NSLayoutAttributeNotAnAttribute
    ...
    CGFloat scrollViewHeight = [_titleLabel sizeThatFits:CGSizeMake(containerWidth, 0)].height+[_messageOffLineLabel sizeThatFits:CGSizeMake(containerWidth, 0)].height+padding;
...
- (_Nonnull instancetype)initWithTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message {
    ...
    _scrollView = [[UIScrollView alloc] init];
    _titleLabel = [[UILabel alloc] init];
    _messageLabel = [[UIWebView alloc] initWithFrame:CGRectMake(0, 50, alertWidth, 200)];
...
//    _messageLabel.font = [UIFont systemFontOfSize:13.0];
    ...
    [_messageLabel loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:message]]];
...
- (void)addAction:(CYAlertAction * _Nonnull)action {
    ...
    [actionButton setTitleColor:[UIColor colorWithWhite:0.067 alpha:1.000] forState:UIControlStateNormal];
    actionButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    actionButton.contentEdgeInsets = UIEdgeInsetsMake(0,10, 0, 0);
    [actionButton setTitleColor:[UIColor colorWithRed:0.000 green:0.600 blue:0.992 alpha:1.000] forState:UIControlStateHighlighted];
