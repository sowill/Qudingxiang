...
@interface gameToMapPush()
@property (nonatomic,strong)id<UIViewControllerContextTransitioning> transitionContext;
@end

@implementation gameToMapPush
...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    MapViewController *toVC = (MapViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    
    //获取容器视图
    UIView *contView = [transitionContext containerView];
    
    UIButton *button = fromVC.presentButton;
