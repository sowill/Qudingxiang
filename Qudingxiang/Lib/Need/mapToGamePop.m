...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    MapViewController *fromVC = (MapViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    BaseGameViewController *toVC   = (BaseGameViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    UIView *containerView = [transitionContext containerView];
    UIButton *button = toVC.presentButton;
    ...
    UIBezierPath *finalPath = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(button.frame.origin.x, button.frame.origin.y + 64, button.frame.size.width, button.frame.size.height)];
