...
- (void)addSubViews
{
    ...
    _quickBtn.tag = 1;
    _desLabel = [ToolView createLabelWithFrame:CGRectMake(38, 10+QdxHeight*0.026, QdxWidth-70, QdxHeight*0.018*2) text:@"路线" font:16 superView:self.contentView];
    _desLabel.textColor = [UIColor colorWithRed:17/255.0f green:17/255.0f blue:17/255.0f alpha:1.0f];;
    _nameLabel = [ToolView createLabelWithFrame:CGRectMake(38, QdxHeight*0.114-QdxHeight*0.018*2, QdxWidth - 70, QdxHeight*0.018*2) text:@"名字" font:13 superView:self.contentView];
