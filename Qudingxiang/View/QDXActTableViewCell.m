...
- (void)addSubViewsNew
{
    ...
    self.act_place = [[UILabel alloc] initWithFrame:CGRectMake(act_place_img.frame.origin.x + FitRealValue(28 + 10), act_place_img.frame.origin.y, FitRealValue(300), FitRealValue(26))];
    self.act_place.text = @"滨江森林公园";
    self.act_place.textColor = QDXGray;
    self.act_place.font = [UIFont systemFontOfSize:14];
    self.act_place.textAlignment = NSTextAlignmentLeft;
    [self.BGView addSubview:self.act_place];
    
    
    UIImageView *act_state_img = [[UIImageView alloc] initWithFrame:CGRectMake(self.act_place.frame.origin.x + FitRealValue(300 + 60), act_place_img.frame.origin.y, FitRealValue(28), FitRealValue(28))];
