...
#define DEFAULTHEADVIEWCOLOR [UIColor whiteColor]
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    view.tag = section;
    CGFloat imgH = height-60;
    CGFloat imgW = imgH;
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(width-imgW-20, (height-imgH)/2, imgW, imgH)];
